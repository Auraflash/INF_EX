...
UPDATEEMAIL='nicomoolies@gmail.com';
INFISTARVERSION='12-Jul-2016 17-00-20 - v0054';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   nicomoolies@gmail.com - 12-Jul-2016 17-00-20 - v0054 - %2 - %3',_t,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_Exile_AdminMenu.hpp in your MPmission is NOT UPDATED   nicomoolies@gmail.com - 12-Jul-2016 17-00-20 - v0054 - %2 - %3',_t,serverName,productVersion];
...
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    nicomoolies@gmail.com - 12-Jul-2016 17-00-20 - v0054 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_RL = compileFinal "
	...
	_buildurl = format['http://htmlload.infistar.de/rl.php?owner=nicomoolies@gmail.com&owneruid=76561198075229326&infistarversion=12-Jul-2016 17-00-20 - v0054&servername=%1&logname=%2&logentry=%3',serverName,_logname,_logentry];
...
_fnc_RandomGen =
{
	...
	_fnc_actualGen = {
		...
		_main	= ['I','r','7','y','T','8','c','M','H','p','O','h','5','C','U','g','5','f','m','j','u','9','u','1','g','z','R','s','x','i'];
...
[
	[_admins],
	{
		...
		_devLog = format['infiSTAR.de AHAT %1 - 12-Jul-2016 17-00-20 - v0054 - server running: %2:1083 - AdminNameTag: "+str _AdminNameTag+"',VERSIONCHECKRESULT,call _GET_TIME_TIME];diag_log _devLog;
		"; if(!_HIDE_FROM_PLAYERS)then{ _A3AHstring = _A3AHstring + "
...
_from = 'nicomoolies@gmail.com';
_vers = '12-Jul-2016 17-00-20 - v0054';
